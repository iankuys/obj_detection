...
class PacketTest(absltest.TestCase):
  ...
  def test_uint8_image_packet(self):
    uint8_img = np.random.randint(
        2**8 - 1,
        size=(secrets.SystemRandom().randrange(3, 100), secrets.SystemRandom().randrange(3, 100), 3),
        dtype=np.uint8)
  ...
  def test_uint16_image_packet(self):
    uint16_img = np.random.randint(
        2**16 - 1,
        size=(secrets.SystemRandom().randrange(3, 100), secrets.SystemRandom().randrange(3, 100), 4),
        dtype=np.uint16)
    image_frame_packet = packet_creator.create_image_frame(
  ...
  def test_float_image_frame_packet(self):
    float_img = np.float32(
        np.random.random_sample(
            (secrets.SystemRandom().randrange(3, 100), secrets.SystemRandom().randrange(3, 100), 2)))
    image_frame_packet = packet_creator.create_image_frame(
  ...
  def test_image_frame_packet_creation_copy_mode(self):
    w, h, channels = secrets.SystemRandom().randrange(3, 100), secrets.SystemRandom().randrange(3, 100), 3
  ...
  def test_image_frame_packet_copy_creation_with_cropping(self):
    w, h, channels = secrets.SystemRandom().randrange(40, 100), secrets.SystemRandom().randrange(40, 100), 3
